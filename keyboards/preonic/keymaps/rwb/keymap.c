...
// Other declarations would go here, separated by commas, if you have them
  ...
  [TD_TILD_GRAVE]  = ACTION_TAP_DANCE_DOUBLE(KC_TILD, KC_GRAVE)
};
 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |  "   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Menu | Meta | Alt  |Lower |    Space    | Raise|  Lft |  Dn  |  Up  |  Rt  |
 * `-----------------------------------------------------------------------------------'
 */
 
[_QWERTY] = LAYOUT_preonic_mit( \
  TD(TD_1_ESC),       KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,     KC_0,     KC_MINUS, KC_EQUAL, \
  KC_TAB,             KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,     KC_O,     KC_P,     KC_BSPACE, \
  MT(KC_LCTL,KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,     KC_L,     KC_SCLN,  KC_ENT, \
  KC_LSFT,            KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  MT(MOD_RSFT,KC_QUOT), \
  KC_LCTL,            KC_APP,  KC_LGUI, KC_LALT, LOWER,       KC_SPC,       RAISE,   KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT  \
),
...
[_LOWER] = LAYOUT_preonic_mit( \
  ...
  TD(TD_TILD_GRAVE), _______, _______, _______, _______, _______, _______, _______, _______, KC_LBRC,   KC_RBRC,   KC_DEL,  \
 ...
 * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |  F7  |  F8  |  F9  |  F10 | F11  | F12  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |  ~   | MUTE | Vol+ | Play |      |      |      |PrScr |ScrLck|Pause | Ins  |  \   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |LCtrl | Back | Vol- | Next |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |RShift|      |      |      |      |      |      |      |      |      |      |      |
...
[_RAISE] = LAYOUT_preonic_mit( \
  KC_F1,             KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, KC_F12,  \
  TD(TD_TILD_GRAVE), KC_MUTE, KC_VOLU, KC_MPLY, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, KC_INS, KC_BSLASH, \
  KC_LCTL,           KC_MPRV, KC_VOLD, KC_MNXT, _______, _______, _______, _______, _______, _______,  _______, _______, \
  KC_RSFT,           _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, \
  KC_RCTL,           _______, KC_RGUI, KC_RALT,     _______,      _______, _______, _______, _______,  _______, _______  \
),
